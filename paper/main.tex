...
All data processing, model estimation, and evaluation code are publicly available at \url{https://github.com/ngvthoang/PROJECT\_TimeSeries}. The codebase has been refactored into a structured Python package using the \texttt{src} layout with \texttt{uv} package management. Key entry points:
